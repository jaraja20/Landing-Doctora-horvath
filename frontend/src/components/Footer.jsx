    ...
    <footer className="bg-white border-t border-black/[0.06] py-14" data-testid="footer">
      <div className="max-w-7xl mx-auto px-6 lg:px-10 flex flex-col sm:flex-row items-center sm:items-start justify-between gap-10">
        <div className="flex items-center gap-4">
          <img src="/assets/logo-stamp.png" alt="Dra. Gabriela Horvath" className="w-16 h-16" data-testid="footer-logo" />
        ...
        <div className="text-center sm:text-right">
          ...
          <a href="https://www.tekohasystems.com" target="_blank" rel="noopener noreferrer" data-testid="footer-tekoha-credit"
            className="mt-2 inline-block text-xs text-black/40 hover:text-corp underline underline-offset-4 decoration-black/20 hover:decoration-corp transition-colors">
            {t.footer.credit}
          </a>
        </div>
      </div>
